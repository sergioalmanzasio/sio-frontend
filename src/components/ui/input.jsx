  ...
  return (
    ...
    <div className={"relative flex items-center w-full" + className}>
      ...
      <input
        ...
        type={inputType}
        className={
          "w-full p-2 border border-gray-300 rounded-lg text-gray-700 placeholder-gray-500 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition duration-300" +
