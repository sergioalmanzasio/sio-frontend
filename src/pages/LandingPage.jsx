  ...
  return (
    <div className="font-[Inter] min-h-screen  flex flex-col justify-between antialiased bg-gray-50">
      ...
      <div className="fixed bottom-8 right-8 flex items-center justify-center z-50">
        ...
        >
          <span className="animate-ping absolute inline-flex h-12 w-12 rounded-full bg-green-500 opacity-75"></span>
          <div className="relative bg-[#25D366] p-3 rounded-full shadow-lg group-hover:animate-none transition-all">
            <svg
