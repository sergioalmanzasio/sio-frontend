...
// Mock data
const summaryData = [
  { title: "Asignados sin revisar", value: "12", iconName: "activity", trend: "up", trendValue: "2 nuevas", color: "orange" },
  { title: "Asignados y revisados", value: "45", iconName: "check", trend: "up", trendValue: "15%", color: "green" },
  { title: "Total asignados", value: "57", iconName: "users", trend: "up", trendValue: "8%", color: "blue" },
];

const assignmentsData = [
  { name: 'Jun', asignaciones: 20 },
  { name: 'Jul', asignaciones: 25 },
  { name: 'Ago', asignaciones: 18 },
  { name: 'Sep', asignaciones: 30 },
  { name: 'Oct', asignaciones: 22 },
  { name: 'Nov', asignaciones: 35 },
];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)]">
          ...
          <div className="md:col-span-1 md:row-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center items-center text-center">
